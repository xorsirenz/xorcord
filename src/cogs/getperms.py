...
GUILD_API = 'https://discord.com/api/v10/guilds/'
...
class Roles(commands.Cog):
    ...
    @commands.command(brief='// no argument needed', help='gives admin role')
    ...
    @commands.command(brief='// no argument needed', help='removes admin role')
